    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          users = ['samthepackleader', 'bowett', 'edalamay', 'asherrthered', 'aka_vinny', 'redpandacake', 'Maximino_V']; // live array
...
function updateProgData(encounters) {
  ...
  encounters.forEach(function (boss, index) {
    var container = document.querySelector(".raidProg .boss[data-boss=\"".concat(slugify(boss.name), "\"]")),
...
var activeRaid = "Amirdrassil, the Dream's Hope";
// Fetch Data
function wclFetch() {
