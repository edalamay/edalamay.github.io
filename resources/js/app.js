...
//===========================================
	...
	async function getStreams() {
		...
		const users = ['samthepackleader','bowett','edalamay','asherrthered','aka_vinny',,'plaguebearr']; // live array
