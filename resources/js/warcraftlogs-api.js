...
// Data for chart title & subtitle - manually update this during prog?
	...
	export function createProgChart(bossId) {
...
//--------
// v3
// - Added functionality to display charts for all bosses. 
// - Moved primary logic into `app.js` because I needed to reference this function
//--------
...
//--------
// v4
// - Rewrote most of the logic to pull from a new endpoint, uses fetch in the browser so no more fetching and storing from the server side!
// - Also includes logic to update the chart every 5 minutes with hot, fresh data
//--------
